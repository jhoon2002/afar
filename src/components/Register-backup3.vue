                            ...
                            >
                                ...
                                <v-row>
                                    <v-col cols="12" class="d-flex">
                                        <validation-provider name="주민등록번호(앞번호)" :rules="{ required: true, numeric: true, length: 6 }" v-slot="{ errors, valid }">
                                            <v-text-field label="주민등록번호" v-model="jumin1" outlined counter="6"
                                                          :error-messages="errors" :success="valid" id="input-jumin1"
                                                          style="max-width: 10rem"
                                                          @input="nextFocus()"
                                            ></v-text-field>
                                        </validation-provider>
                                        <validation-provider name="주민등록번호(성별)" :rules="{ required: true, numeric: true, length: 1 }" v-slot="{ errors, valid }">
                                            <v-text-field label="" v-model="jumin2" outlined counter="1"
                                                          :error-messages="errors" :success="valid" id="input-jumin2" ref="jumin2"
                                                          class="ml-2"
                                                          style="max-width: 3rem"
                                            ></v-text-field>
                                        </validation-provider>
                                        <validation-provider name="주민등록번호(뒷번호)" :rules="{ required: true, numeric: true, length: 7 }" v-slot="{ errors, valid }">
                                            <v-text-field label="" v-model="jumin3" outlined counter="7"
                                                          :error-messages="errors" :success="valid" id="input-jumin3"
...
<script>
    export default {
        ...
        methods: {
            ...
            nextFocus() {
                if (this.jumin1.length >= 6) {
                    this.$refs.jumin2.focus()
                }
            }
        },
        watch: {
